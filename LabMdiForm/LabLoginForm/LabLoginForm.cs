...
namespace Harry.LabMainForm
{
	public partial class LabLoginForm : Form
	{
		...
		private void StartUpInit()
		{
			...
			this.button_Logoff.Click += new EventHandler(this.Button_Click);
		}
		...
		private void Form_FormClosing(object sender, FormClosingEventArgs e)
		{
			switch (e.CloseReason)
			{
				...
				case CloseReason.UserClosing:
					if (DialogResult.OK == MessageBoxPlus.Show(this, "你确定要关闭退出登录吗？", "关闭提示", MessageBoxButtons.OKCancel, MessageBoxIcon.Question))
					{
