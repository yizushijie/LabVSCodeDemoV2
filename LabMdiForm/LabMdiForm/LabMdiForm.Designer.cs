namespace Harry.LabMainForm
{
    partial class LabMdiForm
    {
        ...
        private void InitializeComponent()
        {
			...
			resources.ApplyResources(this.ToolStripSeparator_File1, "ToolStripSeparator_File1");
			// 
			...
			resources.ApplyResources(this.ToolStripMenuItem_Func, "ToolStripMenuItem_Func");
			// 
			// ToolStripMenuItem_Wind
			// 
			this.ToolStripMenuItem_Wind.Name = "ToolStripMenuItem_Wind";
			resources.ApplyResources(this.ToolStripMenuItem_Wind, "ToolStripMenuItem_Wind");
			// 
			...
			resources.ApplyResources(this.ToolStripMenuItem_Tool, "ToolStripMenuItem_Tool");
			// 
			// ToolStripMenuItem_Calc
			// 
			this.ToolStripMenuItem_Calc.Name = "ToolStripMenuItem_Calc";
			resources.ApplyResources(this.ToolStripMenuItem_Calc, "ToolStripMenuItem_Calc");
			// 
			// ToolStripMenuItem_TXT
			// 
			this.ToolStripMenuItem_TXT.Name = "ToolStripMenuItem_TXT";
			resources.ApplyResources(this.ToolStripMenuItem_TXT, "ToolStripMenuItem_TXT");
			// 
			// ToolStripSeparator_Tool1
			// 
			this.ToolStripSeparator_Tool1.Name = "ToolStripSeparator_Tool1";
			resources.ApplyResources(this.ToolStripSeparator_Tool1, "ToolStripSeparator_Tool1");
			// 
			// ToolStripMenuItem_Custom
			// 
			this.ToolStripMenuItem_Custom.Name = "ToolStripMenuItem_Custom";
			resources.ApplyResources(this.ToolStripMenuItem_Custom, "ToolStripMenuItem_Custom");
			// 
			// ToolStripMenuItem_Option
			// 
			this.ToolStripMenuItem_Option.Name = "ToolStripMenuItem_Option";
			resources.ApplyResources(this.ToolStripMenuItem_Option, "ToolStripMenuItem_Option");
			// 
			...
			resources.ApplyResources(this.statusStrip_MdiFormStatu, "statusStrip_MdiFormStatu");
			...
			resources.ApplyResources(this.ToolStripStatusLabel_Separator1, "ToolStripStatusLabel_Separator1");
			...
			resources.ApplyResources(this.ToolStripStatusLabel_SysTime, "ToolStripStatusLabel_SysTime");
			// 
