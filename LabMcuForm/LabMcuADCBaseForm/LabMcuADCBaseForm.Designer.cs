namespace Harry.LabMcuForm
{
	partial class LabMcuADCBaseForm
	{
		...
		private void InitializeComponent()
		{
			...
			// groupBox_TestDevice
			// 
			this.groupBox_TestDevice.Controls.Add(this.panel3);
			this.groupBox_TestDevice.Controls.Add(this.groupBox_ScanADCFunc);
			this.groupBox_TestDevice.Controls.Add(this.panel2);
			this.groupBox_TestDevice.Controls.Add(this.panel1);
			...
			// panel3
			// 
			this.panel3.Controls.Add(this.numericUpDownPlus_SampleNum);
			this.panel3.Controls.Add(this.label_ADCSampleNum);
			this.panel3.Controls.Add(this.button_WriteADCSampleNum);
			this.panel3.Controls.Add(this.button_ReadADCSampleNum);
			...
			// panel2
			// 
			this.panel2.Controls.Add(this.label_SelectADCChannel);
			this.panel2.Controls.Add(this.comboBoxEx_SelectADCChannel);
			this.panel2.Controls.Add(this.button_WriteADCChannel);
			this.panel2.Controls.Add(this.button_ReadADCChannel);
			...
			// panel1
			// 
			this.panel1.Controls.Add(this.label_SelectADCVREF);
			this.panel1.Controls.Add(this.comboBoxEx_SelectADCVREFMode);
			this.panel1.Controls.Add(this.button_WriteADCVREFMode);
			this.panel1.Controls.Add(this.button_ReadADCVREFMode);
		...
		private System.Windows.Forms.GroupBox groupBox_ScanADCFunc;
